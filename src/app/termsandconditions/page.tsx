  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to From Lines to Life.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to From Lines to Life, accessible
            from{' '}
            <a
              href='https://fromlinestolife.vercel.app/'
              rel='external nofollow noopener'
              target='_blank'
            >
              https://fromlinestolife.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        USD if You haven&rsquo;t purchased anything through the Service.
      </p>
      <p>
      ...
      <ul>
        <li>
          <p>By email: artur.buja2@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{' '}
            <a
              href='https://fromlinestolife.vercel.app/contact'
              rel='external nofollow noopener'
              target='_blank'
            >
              https://fromlinestolife.vercel.app/contact
            </a>
          </p>
        </li>
      </ul>
